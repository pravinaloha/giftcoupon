...
class Bloyal_Gift_Model_Observer {
    ...
    public function hookIntoCatalogProductNewAction($observer) {
        ...
        Mage::log('In hookIntoCatalogProductNewAction', Zend_Log::DEBUG, 'loyalty.log');
        Mage::log($product, Zend_Log::DEBUG, 'loyalty1.log');
        return $this;
    }
    ...
    public function hookIntoCatalogProductEditAction($observer) {
        ...
        Mage::log('In hookIntoCatalogProductEditAction', Zend_Log::DEBUG, 'loyalty.log');
        Mage::log($product, Zend_Log::DEBUG, 'loyalty1.log');
    ...
    public function hookIntoCatalogProductPrepareSave($observer) {
        ...
        Mage::log('In hookIntoCatalogProductPrepareSave' . $event, Zend_Log::DEBUG, 'loyalty.log');
        Mage::log($product, Zend_Log::DEBUG, 'loyalty1.log');
    ...
    public function hookIntoSalesOrderItemSaveAfter($observer) {
        ...
        Mage::log('In hookIntoSalesOrderItemSaveAfter' . $event, Zend_Log::DEBUG, 'loyalty.log');
    ...
    public function hookIntoSalesOrderSaveBefore($observer) {
        ...
        Mage::log('In hookIntoSalesOrderSaveBefore' . $event, Zend_Log::DEBUG, 'loyalty.log');
    ...
    public function hookIntoSalesOrderSaveAfter($observer) {
                    ...
                    if ($order->getId()) {
                        try {
                            ...
                            $vars = Array('order' => $order,
                                'bloyalGiftCardNumber' => $giftcardnumber);
        ...
        Mage::log('In hookIntoSalesOrderSaveAfter' . $event, Zend_Log::DEBUG, 'loyalty.log');
        Mage::log($product, Zend_Log::DEBUG, 'loyalty1.log');
