...
class Bloyal_Pay_Model_Quote_Discount extends Mage_Sales_Model_Quote_Address_Total_Abstract {

    public function __construct() {
        $this->setCode('bloyalgiftcard');
    }
    ...
    public function getLabel() {
        return Mage::helper('pay')->__('Bloyal Gift Card');
    }
